...
class Notice extends Admin
{
    ...
    {
        $lists = Db::table('twothink_notice')->limit(3)->select();
...
//        var_dump($_FILES);die();
    ...
    public function edit()
    {
        ...
        if ($request->isPost()) {
            ...
            unset($data['file']);
            $res = Db::table('twothink_notice')->where('id', $data['id'])->update($data);
            if ($res) {
        ...
        //var_dump($data);die();
        $ns = Db::table('twothink_notice')->where('id', $id)->select();
        // var_dump($ns);die();
        $this->assign('ns', $ns);
    ...
    public function del()
    {
        ...
        $id = $request->get('id');
        //var_dump($id);die();
       $model=Db::table('twothink_notice')->delete($id);
       if ($model){
