...
class Area extends Admin{
    ...
    {
        $lists = Db::table('twothink_area')->select();
    ...
    public function add()
    {
        ...
        if ($request->isPost()) {
            ...
            if ($result) {
                unset($data['file']);
                Db::table('twothink_area')->insert($data);
                //跳转页面
...
//        var_dump($_FILES);die();
    ...
    public function edit()
    {
        ...
        if ($request->isPost()) {
            ...
            unset($data['file']);
            $res = Db::table('twothink_area')->where('id', $data['id'])->update($data);
            if ($res) {
        ...
        //var_dump($data);die();
        $services = Db::table('twothink_area')->where('id', $id)->find();
//         var_dump($services);die();
    ...
    public function del()
    {
        ...
        $id = $request->get('id');
        //var_dump($id);die();
        $model = Db::table('twothink_area')->delete($id);
        if ($model) {
