        ...
        <div class="margin-top-10">
            <table class="table table-bordered table-striped table-hover">
                ...
                <tr>
                    ...
                    <td><?=$p['status']==1?'待处理':'已处理'?></td>
                    <td>
                        <a href="<?php echo url('admin/property/edit'); ?>?id=<?=$p['id']?>">修改</a>
                        <a href="<?php echo url('admin/property/del'); ?>?id=<?=$p['id']?>">删除</a>
                    </td>
                </tr>
                <?php endforeach;?>
                </tbody>
