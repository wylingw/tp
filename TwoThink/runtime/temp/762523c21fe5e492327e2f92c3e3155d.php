        ...
        <div class="margin-top-10">
            <table class="table table-bordered table-striped table-hover">
                ...
                <tr>
                    ...
                    <td>
                        <a href="<?php echo url('admin/service/edit'); ?>?id=<?=$p['id']?>">修改</a>
                        <a href="<?php echo url('admin/service/del'); ?>?id=<?=$p['id']?>">删除</a>
                    </td>
                </tr>
                <?php endforeach;?>
