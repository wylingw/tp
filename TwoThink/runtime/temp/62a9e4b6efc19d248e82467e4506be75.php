        ...
        <div class="margin-top-10">
            <table class="table table-bordered table-striped table-hover">
                ...
                <tr id="content" page="1">
                    ...
                    <td>
                        <a href="<?php echo url('admin/notice/edit'); ?>?id=<?=$p['id']?>">修改</a>
                        <a href="<?php echo url('admin/notice/del'); ?>?id=<?=$p['id']?>">删除</a>
                    </td>
                </tr>
                <?php endforeach;?>
