            ...
            <ul class="tab-nav nav nav-tabs">
                ...
                <li class="pull-right">
                    <select class="form-control" name="group">
                        ...
                        <option value="<?php echo url('AuthManager/access',array('group_id'=>$vo['id'],'group_name'=>$vo['title'])); ?>" <?php if($vo['checked'] == 'true'): ?>selected<?php endif; ?>><?php echo $vo['title']; ?></option>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </li>
            </ul>
            <div class="two-tab-content margin-top-10">
                ...
                <div class="tab-pane in">
                    <!--<form action="<?php echo url('AuthManager/writeGroup'); ?>" enctype="application/x-www-form-urlencoded" method="POST" class="form-horizontal auth-form">-->
                        ...
                        <input type="hidden" name="id" value="<?php echo input('group_id'); ?>" />
...
<script type="text/javascript" >
    ...
    var zNodes =<?php echo json_encode($node_list); ?>;
    ...
    $(document).ready(function(){
        ...
        $(".ajax-posts").click(function(){
            ...
            $.post("<?php echo url('AuthManager/writeGroup'); ?>",{'rules':data,'id':id}).done(function(data){
                if(data.code == 1){
