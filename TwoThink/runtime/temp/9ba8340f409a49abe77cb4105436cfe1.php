<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"D:\www\TwoThink\public/../application/admin/view/default/service\edit.html";i:1522036012;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="main">
    ...
    <div class="container-fluid">
        ...
        <form action=" <?php echo url('admin/service/edit'); ?>" method="post">
            ...
            <div class="form-group">
                ...
                发布:<input type="radio" name="status"   value="" <?=$services['status']==1?'checked':''?> />
                禁用:<input type="radio" name="status"   value="" <?=$services['status']==1?'':'checked'?>/>
            </div>
            <div class="form-group">
                <label>发布者(必填):</label>
