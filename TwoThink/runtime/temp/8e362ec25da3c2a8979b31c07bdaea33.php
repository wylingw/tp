<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"D:\www\TwoThink\public/../application/admin/view/default/active\add.html";i:1522035065;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="main">
    ...
    <div class="container-fluid">
        ...
        <form action=" <?php echo url('admin/active/add'); ?>" method="post">
            ...
            <div class="form-group">
                ...
                未发布:<input type="radio" name="status"   value="2"/>
            </div>
            <div class="form-group">
                <label>活动时间(必填):</label><br>
                开始时间:<input type="date" name="start_time"   value="1"/>
                结束时间:<input type="date" name="end_time"   value="2"/>
            </div>
            <div class="form-group">
                <label>发布者(必填):</label>
