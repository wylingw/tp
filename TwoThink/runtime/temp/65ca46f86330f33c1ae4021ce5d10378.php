<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"D:\www\TwoThink\public/../application/home/view/default/index\index.html";i:1522230036;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="container-fluid">
    <div class="indexImg row">
        <img src="__PUBLIC__/twothink/image/index.png" width="100%" />
    </div>
    <div class="serviceList text-center">
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-4">
                    <a href="<?php echo url('home/active/index'); ?>">
                ...
                <div class="col-xs-4">
                    <a href="<?php echo url('home/rent/index'); ?>">
                ...
                <div class="col-xs-4">
                    <a href="<?php echo url('home/area/index'); ?>">
...
<script src="__PUBLIC__/twothink/jquery-1.11.2.min.js"></script>
