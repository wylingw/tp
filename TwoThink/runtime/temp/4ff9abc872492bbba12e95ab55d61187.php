<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:50:"D:\www\TwoThink\addons\editorforadmin\content.html";i:1521685275;}*/ ?>
<?php switch($addons_config['editor_type']): case "1": ?>
	...
	<?php break; case "2": ?>
		...
		<?php else: ?>
			<script type="text/javascript" charset="utf-8" src="__ADDONS__/editorforadmin/ueditor/ueditor.config.js"></script>
			<script type="text/javascript" charset="utf-8" src="__ADDONS__/editorforadmin/ueditor/ueditor.all.js"></script>
			<script type="text/javascript" charset="utf-8" src="__ADDONS__/editorforadmin/ueditor/lang/zh-cn/zh-cn.js"></script>
			<script type="text/javascript">
				$('textarea[name="<?php echo $addons_data['name']; ?>"]').attr('id', 'editor_id_<?php echo $addons_data['name']; ?>');
				window.UEDITOR_HOME_URL = "__ADDONS__/editorforadmin/ueditor";
