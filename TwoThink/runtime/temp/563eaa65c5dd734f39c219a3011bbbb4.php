<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"D:\www\TwoThink\public/../application/home/view/default/service\index.html";i:1522033094;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="main">
    ...
    <div class="container-fluid">
        ...
        <div class="row noticeList">
            <a href="<?php echo url('service/detail'); ?>?id=<?=$n['id']?>">
                ...
                <div class="col-xs-10">
                    ...
                    <p class="intro"><?=mb_substr($n['content'],0,20)?>......</p>
